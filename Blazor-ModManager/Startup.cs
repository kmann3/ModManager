...
using Blazor_ModManager.Areas.Identity;
using Blazor_ModManager.Data;
using ModManager.Db;
using Microsoft.AspNetCore.Identity.EntityFrameworkCore;

namespace Blazor_ModManager
{
    public class Startup
    {
        ...
        {
#if DEBUG
            ModManDbContext.ConnectionString = Configuration.GetConnectionString("KennyLocal");
#else
            ModManDbContext.ConnectionString = Configuration.GetConnectionString("SmarterASP");
#endif
